  ...
  return (
    <label className="flex min-w-[200px] flex-col gap-2">
      ...
      <select
        ...
        className="ls-select h-12 px-4 text-base font-semibold text-[var(--ls-text)] outline-none ring-emerald-400 transition focus:ring-2 disabled:cursor-not-allowed disabled:opacity-70"
      >
